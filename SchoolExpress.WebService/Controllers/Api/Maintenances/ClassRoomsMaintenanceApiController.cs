...
{
    [RoutePrefix("api/maintenances/classrooms")]
    public class ClassRoomsMaintenanceApiController : MaintenanceApiController<ClassRoom>
    {
        public ClassRoomsMaintenanceApiController(ISchoolExpressUow uow) : base(uow)
        {
        }

        [Authorize(Roles = "api.maintenances.classrooms.get")]
        ...
        [Authorize(Roles = "api.maintenances.classrooms.put")]
