...
{
    [RoutePrefix("api/maintenances/people")]
    public class PeopleMaintenanceApiController : MaintenanceApiController<Person>
    {
        public PeopleMaintenanceApiController(ISchoolExpressUow uow) : base(uow)
        {
        }

        [Authorize(Roles = "api.maintenances.people.get")]
