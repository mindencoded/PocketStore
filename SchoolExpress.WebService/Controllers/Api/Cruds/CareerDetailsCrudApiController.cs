...
{
    [RoutePrefix("api/cruds/careerdetails")]
    public class CareerDetailsCrudApiController : CrudApiController<CareerDetail>
    {
        ...
        [Authorize(Roles = "api.cruds.careerdetails.get")]
        ...
        [Authorize(Roles = "api.cruds.careerdetails.put")]
